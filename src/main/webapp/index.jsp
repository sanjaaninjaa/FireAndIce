    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1>It doesn't matter where you are, you are nowhere compared to where you can go.</h1>
                <p>-Bob Proctor</p>
                <a href="login.html" class="btn btn-primary btn-lg">Engage Now (Login)</a>
            </div>
        </div>
    </header>
	...
	<!-- Content 3 -->
     <section class="content content-3">
        <div class="container">
			...
			<p class="lead text-muted">Holisticly predominate extensible testing procedures for reliable supply chains. Dynamically innovate resource-leveling customer service for state of the art customer service.</p> 
                    <a href="login.html" class="btn btn-primary btn-lg">Check Now</a>               
            </div>
        </div>
    </section>
    ...
    <footer class="page-footer">
        ...
        <div class="contact">
        	<div class="container">
				...
				<p><span class="glyphicon glyphicon-earphone"></span><br> +1(23) 456 4613</p>
				<p><span class="glyphicon glyphicon-envelope"></span><br> sanjayrgaikwad@gmail.com</p>
        	</div>
        </div>
